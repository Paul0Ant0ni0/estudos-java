 ...
 *     Construtores: Cria bichinhos com base nos atributos nome, idade, peso. Bucho deve começar com
 *     lista vazia. estaDormindo deve iniciar false.
 *     Métodos:
 *         - comer(Comida comida) => a comida deve alterar o peso do bichinho, o bichinho não come
 *         a mesma comida duas vezes. Ele não come se estiver dormindo!
 *        - dormir(int horas) => altera o boolean estaDormindo p/ true, para cada hora
 *        dormida o bichinho perde 10% de seu peso atual;
...
public class Bichinho {
    ...
    public void comer(Comida comida){
        if (estaDormindo){
            ...
            if (bucho.contains(comida)){ // ele já comeu
                ...
                System.out.println("Hummmm que delicia");
            }
    ...
    public void dormir(int horas){
        double porcentagem = this.peso * 0.1;
        double quilosPerdidos = horas + porcentagem;
